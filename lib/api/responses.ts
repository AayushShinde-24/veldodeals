...
const VENDOR_PATTERN =
  /\b(google|gmail|outlook|microsoft|office\s?365|apollo|clay|openai|gpt|anthropic|claude|firecrawl|tavily|zerobounce|resend|serpapi|apify|stripe|hubspot|salesforce|pipedrive|slack|calendly|linkedin|posthog|sentry|twilio|me5|enrich)\b/iu;
